...
export const StageTexUrl: string[] = [
    ...
    // target Glass
    "res/stage/out/materials/Glass.jpg",
    // target normal
    "res/stage/out/materials/stack_texture.jpg",
    "res/stage/out/materials/stack_texture1.jpg",
...
/** cdn */
export const cdnUrl: string = "https://coolant.miniant.cn/cannon/res_v128.zip";

/** sound */
export const soundUrl: string[] = [
    "res/audio/shoot.mp3",
    "res/audio/blackhole.mp3",
    "res/audio/winner.mp3",
    "res/audio/broken.mp3",
];
...
export const BulletEffectUrl = {
    1: "res/bullet/boom/boomTrail.lh",      // boomTrail
    2: "res/bullet/lightning/lightning.lh", // lightning
    3: "res/bullet/bombEff/bombEff.lh",     // bomb bullet
};
/** reward bullet */
...
export const CannonSelectTextList = {
    ...
    5: {name: "黄金狮子头", feature: "河东狮吼，十分暴躁", unlockLvl: 30, unlockDiamond: 15000},
