...
export module ui.game {
    export class GameSceneUI extends View {
		...
		public label_rewardCannon:Laya.Label;
		...
		public input_test_reTimes:Laya.TextInput;
		public label_test_lvl:Laya.Label;
		public label_test_reTimes:Laya.Label;
		public label_test_objs:Laya.Label;
...
export module ui.home {
    export class HomeViewUI extends View {
		...
		public btn_trailSelect4:Laya.Image;
		public btn_trailUnlock4:Laya.Image;
		public label_trailUnlockMsg4:Laya.Label;
		public trailUsing4:Laya.Image;
		public trailWait4:Laya.Image;
        constructor(){ super()}
        createChildren():void {
            super.createChildren();
